...
export const createChatSlice: StateCreator<CombinedSlice, [], [], ChatSlice> = (set, get) => ({
    chats: {
        global: {
            id: 'global',
            messages: [],
    ...
    addChatMessage: (msg, chatId) =>
        set((state) => {
            ...
            const isPlayerPrivateOpenAndTarget =
                isPrivate && isPlayer && state.openChatTab === OpenChatTab.Private;
        ...
        set((state) => {
            ...
            return {
                chats: {
                    ...
                    [chatId]: {
                        ...state.chats[chatId],
                        members: [...state.chats[chatId].members, memberId],
                    },
                },
            };
        }),
    ...
    removeMemberFromChat: (chatId, memberId) =>
        set((state) => {
            ...
            return {
                chats: {
                    ...state.chats,
                    [chatId]: { ...state.chats[chatId], members: newMembers },
                },
            };
        }),
    ...
    setOpenChatTab: (tab: OpenChatTab) =>
        set(() => {
