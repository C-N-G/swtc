            ...
            <Grid container alignItems="center">
                <Grid item xs={4} container justifyContent="center">
                    <ButtonGroup size="small" orientation="vertical">
                        <Button onClick={() => setOpenDialog(OpenDialog.Scenario)}>
                            Show Scenario
                        </Button>
                        {voting ? (
                            <Button onClick={() => displayVote()}>
                                Show Vote ({voteTimer.time})
                            </Button>
                        ) : (
                            ''
                        )}
                ...
                <Grid item xs={4} container justifyContent="center">
                    <ButtonGroup size="small" orientation="vertical">
                        ...
                        <Button
                            ...
                            onClick={() => setOpenDialog(OpenDialog.NightOrder)}
                        >
                            Night Order List
                        </Button>
                    </ButtonGroup>
