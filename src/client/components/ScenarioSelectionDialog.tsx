...
function ScenarioSelectionDialog({
    openDialog,
    setOpenDialog,
    allScenarios,
    setNewScenario,
    ...
    return (
        <Dialog
            open={openDialog === OpenDialog.Scenario}
            onClose={() => setOpenDialog(OpenDialog.None)}
        >
            <DialogTitle>Select Scenarios</DialogTitle>
            <DialogContent>
                <List>{allScenarios}</List>
            </DialogContent>
            <DialogActions sx={{ justifyContent: 'space-between' }}>
                <Button variant="outlined" onClick={handleCreate}>
                    Create
                </Button>
                <Button variant="outlined" onClick={() => setOpenDialog(OpenDialog.LoadScenario)}>
                    Load
                </Button>
                <Button variant="outlined" onClick={() => setOpenDialog(OpenDialog.None)}>
                    Close
                </Button>
            </DialogActions>
        </Dialog>
